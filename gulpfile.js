...
gulp.task('watch', ['clean'], function () {
    gulp.watch(path.dev + '**/*.pug', ['pug-watch']);
    gulp.watch(path.dev + '**/*.sass', ['sass-watch']);
    gulp.watch(path.dev + '**/*.js', ['scripts-watch']);
});
...
gulp.task('prod', ['pug', 'sass', 'sass_vendor', 'scripts', 'vendor_scripts', 'fonts', 'img', 'browser-sync']);
